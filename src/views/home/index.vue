      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <img src="src/static/images/7.jpg" alt="image">
    ...
    <div class="container">
      ...
      <div class="team-w3ls">
        <div class="col-md-4 col-sm-4 col-xs-4 team-grid w3_agileits">
          <img class="img-w3l t1-wthree img-responsive" src="src/static/images/t1.jpg" alt="">
          <h5>Mercurio</h5>
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 team-grid w3_agileits t2">
          <img class="img-w3l t1-wthree img-responsive" src="src/static/images/t2.jpg" alt="">
          <h5>Clifford</h5>
          <p>Lorem ipsum dolor sit amet.Cras rutrum iaculis enim, non convallis felis mattis.</p>
          <div class="social-icons">
            <ul>
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 w3_agileits team-grid">
          <img class="img-w3l t1-wthree img-responsive" src="src/static/images/t3.jpg" alt="">
          <h5>Davidson</h5>
          <p>Lorem ipsum dolor sit amet.Cras rutrum iaculis enim, non convallis felis mattis.</p>
...
import '../../static/js/jquery.cm-overlay.js'
import '../../static/js/jquery-1.11.1.min.js'
import '../../static/js/responsiveslides.min.js'
import '../../static/js/jquery.mobile.custom.min.js'
import '../../static/js/jquery.cm-overlay.js'
